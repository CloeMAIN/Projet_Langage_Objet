...
{
private:
    Personnage joueur1{{200, TAILLE_FENETRE.y-HAUTEUR_SOL-128*5}, 100, CHEMIN_IMAGE_JOUEUR1_RIEN};
    Personnage joueur2{{600, TAILLE_FENETRE.y-HAUTEUR_SOL-128*5}, 100, CHEMIN_IMAGE_JOUEUR1_RIEN};
